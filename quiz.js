...
(function () {
  ...
  function buildPrompt(scores, total, maxScore) {
    ...
    return (
      "Сен DigComp 2.2 бойынша цифрлық сауаттылық сарапшысысың. Тек қазақ тілінде жаз.\n\n" +
      "ПАЙДАЛАНУШЫ: " +
      name +
      ", " +
      ageStr +
      ...
      top2 +
      "\n" +
      "Дамыту керек блоктар: " +
      low2 +
      "\n\n" +
      "ТАПСЫРМА: Төмендегі 5 бөлімді ретімен жаз. Әр бөлімді тақырыбынан кейін бірден бастай бер.\n\n" +
      "Жалпы баға\n" +
      name +
      "-ның " +
      total +
      ...
      levelWord +
      " деңгей. " +
      "DigComp 2.2 бойынша бұл деңгейдің күнделікті өмірдегі мәнін 3 сөйлемде нақты түсіндір. " +
      ageStr +
      " және " +
      eduStr +
      " бар адам үшін бұл нәтиже қалай бағаланады — бір сөйлеммен жаз.\n\n" +
      "Блок профилі\n" +
      "5 блокты осы нақты балдар бойынша салыстыр: " +
      blockLines.replace(/\n/g, "; ") +
      ". " +
      "Қай блоктарда үйлесімдік бар, қайсысында алшақтық бар — 2-3 сөйлемде нақты жаз.\n\n" +
      "Күшті жақтар\n" +
      top2 +
      " блоктарын талда. Осы дағдылар " +
      name +
      "-ның күнделікті өмірінде қалай көрінеді — " +
      "2 нақты, өмірлік мысал жаз (мысалы: фишинг хатты тани алу, Google Docs-та бірлесіп жұмыс істеу). " +
      "Жалпы емес — нақты іс-әрекет жаз.\n\n" +
      "Дамыту керек бағыттар\n" +
      low2 +
      " блоктарын талда. Осы олқылық нақты өмірде қандай қауіп туғызады — 1 нақты сценарий жаз. " +
      "Содан кейін әр блок үшін: ресурс атауы (сайт URL-імен), онда не үйренеді — жаз.\n" +
      "Мысал формат: " +
      low2.split(",")[0].trim() +
      " үшін: coursera.org — цифрлық контент курсы.\n\n" +
      "30 күнге оқу жоспары\n" +
      "Тек " +
      low2 +
      " блоктары үшін. Әр апта үшін: сайт атауы + URL, тақырып, күніне нақты минут саны, аптаның соңындағы нақты бір тапсырма.\n" +
      "1-7 күн: [сайт атауы + URL] — [нақты тақырып], күніне [X] минут. 7-күні: [нақты тапсырма].\n" +
      "8-14 күн: [сайт атауы + URL] — [нақты тақырып], күніне [X] минут. 14-күні: [нақты тапсырма].\n" +
      "15-21 күн: [сайт атауы + URL] — практикалық жаттығу, күніне [X] минут. 21-күні: [нақты өзін-өзі тексеру тапсырмасы].\n" +
      "22-30 күн: [сайт атауы + URL] — бекіту, күніне [X] минут. 30-күні: [нақты қолдану тапсырмасы].\n" +
      "Жақшадағы орындарды нақты деректермен толтыр. URL міндетті. Жалпы кеңес жазба.\n\n" +
      "ТЫЙЫМДАР: ** ## таңбаларын қолданба. Бір ойды қайталама. Тек қазақ тілінде."
    );
  }
