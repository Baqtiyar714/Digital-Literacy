...
(function () {
  ...
  function buildPrompt(scores, total, maxScore) {
    ...
    return (
      ...
      "1. Жалпы баға: " +
      overallPct +
      "% нәтижені DigComp 2.2 тұрғысынан бағала, нақты балл санын атап өт. 3-4 сөйлем.\n" +
      "2. Блок профилі: барлық 5 блокты нақты балдармен салыстырып талда. Қай блок неге жоғары/төмен — қысқа түсіндір.\n" +
      "3. Күшті жақтар: тек " +
      top2 +
      " блоктарын талда. Осы дағдылар күнделікті өмірде қалай көрінетінін 2 нақты мысалмен жаз.\n" +
      "4. Дамыту керек бағыттар: тек " +
      low2 +
      " блоктарына арналған талдау. Неге маңызды — нақты сценарий жаз. Әр блок үшін бір нақты тегін ресурс атауын жаз (Coursera, Khan Academy, Google Digital Garage, Kaspersky Academy немесе басқа).\n" +
      "5. 30 күндік жоспар: " +
      low2 +
      " блоктарын дамытуға арналған НАҚТЫ апталық жоспар.\n" +
      "   - 1-7 күн: күніне нақты қанша минут, қай сайтта, қандай тақырып — атап жаз\n" +
      "   - 8-14 күн: алдыңғы аптаға негізделген келесі қадам, нақты тапсырма\n" +
      "   - 15-21 күн: практикалық жаттығу немесе өзін-өзі тексеру тапсырмасы\n" +
      "   - 22-30 күн: нәтижені бекіту, қысқаша тест немесе нақты қолдану тапсырмасы\n" +
      "   Жалпы кеңес емес — НЕ ІСТЕЙДІ, ҚАЙ РЕСУРС, ҚАНША УАҚЫТ — нақты жаз.\n\n" +
