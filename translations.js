const translations = {
  en: {
    ...
    dashboard: {
      ...
      whatIsDesc:
        "Digital literacy is the set of skills for effectively using information and communication technologies (ICT), searching and analyzing information, and operating safely in the digital environment.",
      whyMatters: "Why does it matter?",
      whyMattersDesc:
        "Our system helps you objectively assess your digital skills: to know how ready you are to use technology confidently in work, learning, and daily life.",
      areas: "Areas assessed",
      areasDesc:
        "Information search and analysis, security and personal data protection, communication and collaboration, content creation and use of digital tools.",
      ctaTitle: "Find out your digital literacy level",
      ctaDesc:
        "The test takes 15–20 minutes. Results will show your strengths and areas to improve.",
  ...
  kk: {
    ...
    dashboard: {
      ...
      whatIsDesc:
        "Цифрлық сауаттылық — ақпараттық-коммуникациялық технологияларды (АКТ) тиімді пайдалану, ақпаратты іздеу, талдау және қауіпсіз цифрлық ортада қызмет ету дағдыларының жиынтығы.",
      whyMatters: "Неге маңызды?",
      whyMattersDesc:
        "Біздің жүйе сіздің цифрлық дағдыларыңызды объективті бағалауға көмектеседі: жұмыс, білім алу және күнделікті өмірде технологияны сенімді пайдалану үшін қаншалықты дайын екеніңізді білу.",
      areas: "Бағаланатын салалар",
      areasDesc:
        "Ақпаратты іздеу және талдау, қауіпсіздік және жеке деректерді қорғау, коммуникация және ынтымақтастық, контент жасау және цифрлық құралдарды пайдалану.",
      ctaTitle: "Цифрлық сауаттылығыңызды біліңіз",
      ctaDesc:
        "Тест 15–20 минут алады. Нәтиже сізге әлсіз және күшті жақтарыңызды көрсетеді.",
  ...
  ru: {
    ...
    dashboard: {
      ...
      whatIsDesc:
        "Цифровая грамотность — это совокупность навыков эффективного использования ИКТ, поиска и анализа информации и безопасной работы в цифровой среде.",
      whyMatters: "Почему это важно?",
      whyMattersDesc:
        "Наша система помогает объективно оценить ваши цифровые навыки: насколько вы готовы уверенно использовать технологии в работе, учёбе и повседневной жизни.",
      areas: "Оцениваемые области",
      areasDesc:
        "Поиск и анализ информации, безопасность и защита персональных данных, коммуникация и сотрудничество, создание контента и использование цифровых инструментов.",
      ctaTitle: "Узнайте свой уровень цифровой грамотности",
      ctaDesc:
        "Тест займёт 15–20 минут. Результаты покажут ваши сильные стороны и зоны роста.",
